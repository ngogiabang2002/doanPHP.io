...
<?php include "./Views/Common/menu.php" ?>
    <div class="col-md-6" style="margin: 0 auto">
        <form class="form-horizontal" role="form" method="POST" action="http://localhost/phpmyadmin/AppleStore/index.php?controller=UserController&action=login">
            <input type="hidden" nmea="action" value="register_save">
