    ...
    <div class="container-menu-header-v2 p-t-26">
        <div class="topbar2">
            ...
            <a href="?action=index" class="logo2">
                <img src="Assets/images/icons/applestore.png" alt="IMG-LOGO">
            </a>
                ...
                <div class="header-wrapicon2">
                    ...
                    <div class="header-cart header-dropdown">
                        <ul class="header-cart-wrapitem">
                            <li class="header-cart-item">
                                <div class="header-cart-item-img">
                                    <img src="Assets/images/ip12.jpg" alt="IMG">
                                </div>
                            ...
                            <li class="header-cart-item">
                                <div class="header-cart-item-img">
                                    <img src="Assets/images/ip13.jpg" alt="IMG">
                                </div>
                            ...
                            <li class="header-cart-item">
                                <div class="header-cart-item-img">
                                    <img src="Assets/images/ip14.jpg" alt="IMG">
                                </div>
